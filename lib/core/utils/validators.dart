...
class Validators {
  ...
  static String? validateMatch(String? value, String? matchValue, {String fieldName = 'This field'}) {
    if (value != matchValue) {
  ...
  static String? validateRange(String? value, double min, double max, {String fieldName = 'This field'}) {
    if (value == null || value.isEmpty) {
      return '$fieldName is required';
    }
